  ...
  return (
    <div className="min-h-screen flex flex-col px-6 pt-12 pb-6 font-sans flex items-center">
      ...
      <BaseFieldSet className="mb-4">
        <label className="block text-sm font-semibold mb-2 text-black">Buisness name</label>
        <BaseInput
      ...
      <BaseFieldSet className="mb-4">
        ...
        <BaseFieldSet className="mb-4">
        <label className="block text-sm font-semibold mb-2 text-black">Buisness Email</label>
        <BaseInput
          type="tel"
